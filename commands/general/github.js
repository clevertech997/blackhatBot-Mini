...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/clevertech997/blackhatBot-Mini';
            const apiUrl = 'https://api.github.com/repos/clevertech997/blackhatBot-Mini';
            ...
            try {
                ...
                fallbackMessage += `🔗 *Repository:* blackhatBot-Mini\n`;
                fallbackMessage += `👨‍💻 *Owner:* 𝑨𝒏𝒐𝒏𝒚𝒎𝒐𝒖𝒔 𝑼𝒔𝒆\n`;
